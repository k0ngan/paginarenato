...
**Notas**
- En despliegues serverless, el almacenamiento local puede ser efímero. Para “que quede guardado para todo el mundo” en producción, usa un volumen persistente o un bucket (S3, GCS) montado en el contenedor.
""")
